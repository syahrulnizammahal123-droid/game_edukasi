        ...
        <div class="max-w-5xl mx-auto">
            ...
            <form action="/soal/{{ $soal->id }}" method="POST">
                ...
                <div class="glass rounded-[35px] p-6 lg:p-8 mb-8">
                    ...
                    <textarea name="pertanyaan" rows="4" required class="w-full bg-white/5 border border-white/10 rounded-[30px] p-6 text-white focus:outline-none focus:ring-2 focus:ring-amber-400">{{ old('pertanyaan', $soal->pertanyaan) }}</textarea>
                </div>
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        <div>
                            ...
                            <div class="flex gap-4">
                                ...
                                <input type="text" name="A" required value="{{ old('A', $soal->A) }}" class="flex-1 bg-white/5 border border-white/10 rounded-2xl px-5 text-white focus:outline-none focus:ring-2 focus:ring-amber-400">
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="flex gap-4">
                                ...
                                <input type="text" name="B" required value="{{ old('B', $soal->B) }}" class="flex-1 bg-white/5 border border-white/10 rounded-2xl px-5 text-white focus:outline-none focus:ring-2 focus:ring-amber-400">
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="flex gap-4">
                                ...
                                <input type="text" name="C" required value="{{ old('C', $soal->C) }}" class="flex-1 bg-white/5 border border-white/10 rounded-2xl px-5 text-white focus:outline-none focus:ring-2 focus:ring-amber-400">
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="flex gap-4">
                                ...
                                <input type="text" name="D" required value="{{ old('D', $soal->D) }}" class="flex-1 bg-white/5 border border-white/10 rounded-2xl px-5 text-white focus:outline-none focus:ring-2 focus:ring-amber-400">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="glass rounded-[35px] p-6 lg:p-8 mb-8">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select name="jawaban" required class="w-full bg-white/5 border border-white/10 rounded-2xl px-5 py-4 text-white focus:outline-none focus:ring-2 focus:ring-amber-400">
                                <option class="bg-[#0b1020]" value="A" {{ old('jawaban', $soal->jawaban) == 'A' ? 'selected' : '' }}>Pilihan A</option>
                                <option class="bg-[#0b1020]" value="B" {{ old('jawaban', $soal->jawaban) == 'B' ? 'selected' : '' }}>Pilihan B</option>
                                <option class="bg-[#0b1020]" value="C" {{ old('jawaban', $soal->jawaban) == 'C' ? 'selected' : '' }}>Pilihan C</option>
                                <option class="bg-[#0b1020]" value="D" {{ old('jawaban', $soal->jawaban) == 'D' ? 'selected' : '' }}>Pilihan D</option>
                            </select>
                        </div>
                        <div>
                ...
                <div class="glass rounded-[35px] p-6 lg:p-8 mb-8">
                    ...
                    <textarea name="penjelasan" rows="4" required class="w-full bg-white/5 border border-white/10 rounded-[30px] p-6 text-white focus:outline-none focus:ring-2 focus:ring-amber-400">{{ old('penjelasan', $soal->penjelasan) }}</textarea>
                </div>
